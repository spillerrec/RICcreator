...
$(RICLIB_OBJECT_PATH)/ricObjectDraw.o : $(RICLIB_PATH)/ricObject.h $(RICLIB_PATH)/nxtCanvas.h $(RICLIB_PATH)/ricObjectDraw.cpp
	$(CPP) $(CFLAGS) -c $(RICLIB_PATH)/ricObjectDraw.cpp -o $(RICLIB_OBJECT_PATH)/ricObjectDraw.o
